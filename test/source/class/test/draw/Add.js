...
qx.Class.define("test.draw.Add", {
    ...
    ,members:  {
        ...
        ,create_Add: function create_Add() {
             /* The 'windowTitle' property for widget named 'Add'of type '<class 'jsqt.il.qt.container.QMainWindow'>' is not supported (yet?) */
        ...
        ,create_HLTrackingMethod_2_implicit_container: function create_HLTrackingMethod_2_implicit_container() {
            ...
            retval.add(this.create_lblInterval_2());
        ...
        ,create_HLTrackingMethod_implicit_container: function create_HLTrackingMethod_implicit_container() {
            ...
            retval.add(this.create_horizontalSpacer(), {flex: 1});
            retval.add(this.create_lblInterval());
        ...
        ,create_chkEmail: function create_chkEmail() {
             /* The 'autoRepeat' property for widget named 'chkEmail'of type '<class 'jsqt.il.qt.form.QCheckBox'>' is not supported (yet?) */
        ...
        ,create_chkEmail_2: function create_chkEmail_2() {
             /* The 'autoRepeat' property for widget named 'chkEmail_2'of type '<class 'jsqt.il.qt.form.QCheckBox'>' is not supported (yet?) */
        ...
        ,create_dateEdit: function create_dateEdit() {
             /* The 'dateTime' property for widget named 'dateEdit'of type '<class 'jsqt.il.qt.form.QDateEdit'>' is not supported (yet?) */
        ...
        ,create_dateEdit_2: function create_dateEdit_2() {
             /* The 'dateTime' property for widget named 'dateEdit_2'of type '<class 'jsqt.il.qt.form.QDateEdit'>' is not supported (yet?) */
        ...
        ,create_edtCompany: function create_edtCompany() {
             /* The 'readOnly' property for widget named 'edtCompany'of type '<class 'jsqt.il.qt.form.QLineEdit'>' is not supported (yet?) */
        ...
        ,create_edtCompany_2: function create_edtCompany_2() {
             /* The 'readOnly' property for widget named 'edtCompany_2'of type '<class 'jsqt.il.qt.form.QLineEdit'>' is not supported (yet?) */
        ...
        ,create_edtDNID: function create_edtDNID() {
             /* The 'text' property for widget named 'edtDNID'of type '<class 'jsqt.il.qt.form.QLineEdit'>' is not supported (yet?) */
        ...
        ,create_edtDNID_2: function create_edtDNID_2() {
             /* The 'text' property for widget named 'edtDNID_2'of type '<class 'jsqt.il.qt.form.QLineEdit'>' is not supported (yet?) */
        ...
        ,create_groupBox: function create_groupBox() {
            ...
            layout.setColumnFlex(7,1);
            layout.setColumnFlex(8,1);
            return retval;
        }
        ...
        ,create_horizontalLayout_2_implicit_container: function create_horizontalLayout_2_implicit_container() {
            ...
            retval.setMargin(1);
            retval.add(this.create_lblDNID());
            retval.add(this.create_edtDNID(), {flex: 1});
            retval.add(this.create_lblMN());
            retval.add(this.create_edtMN(), {flex: 1});
            retval.add(this.create_lblSubAddress());
        ...
        ,create_horizontalLayout_7_implicit_container: function create_horizontalLayout_7_implicit_container() {
            ...
            retval.setMargin(1);
            retval.add(this.create_lblIOWN_2());
            retval.add(this.create_edtIOWN_2(), {flex: 1});
            retval.add(this.create_lblTerminalSN_2());
        ...
        ,create_horizontalLayout_8_implicit_container: function create_horizontalLayout_8_implicit_container() {
            ...
            retval.setMargin(1);
            retval.add(this.create_lblDNID_2());
            retval.add(this.create_edtDNID_2(), {flex: 1});
            retval.add(this.create_lblMN_2());
            retval.add(this.create_edtMN_2(), {flex: 1});
            retval.add(this.create_lblSubAddress_2());
        ...
        ,create_horizontalLayout_implicit_container: function create_horizontalLayout_implicit_container() {
            ...
            retval.setMargin(1);
            retval.add(this.create_lblIOWN());
            retval.add(this.create_edtIOWN(), {flex: 1});
            retval.add(this.create_lblTerminalSN());
        ...
        ,create_tabWidget_2: function create_tabWidget_2() {
             /* The 'currentIndex' property for widget named 'tabWidget_2'of type '<class 'jsqt.il.qt.container.QTabWidget'>' is not supported (yet?) */
