...
qx.Class.define("test.draw.Test", {
    ...
    ,members:  {
        ...
        ,create_item_a_new_sub: function create_item_a_new_sub() {
            this.item_a_new_sub = new qx.ui.tree.TreeFile(this.tr("A new Sub"),null,null);
            var retval = this.item_a_new_sub;
            return retval;
        }
        ...
        ,create_item_inside: function create_item_inside() {
            this.item_inside = new qx.ui.tree.TreeFile(this.tr("Inside"),null,null);
            var retval = this.item_inside;
            return retval;
        }

        ,create_item_nested: function create_item_nested() {
            this.item_nested = new qx.ui.tree.TreeFile(this.tr("Nested"),null,null);
            var retval = this.item_nested;
            return retval;
        }
